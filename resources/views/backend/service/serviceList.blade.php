    ...
    <tbody>
        @foreach($services as $key=>$service) 
                <tr>
                  ...
                  <td>
                    <a class="btn btn-success btn-sm" href="{{ route('service.show',$service->id) }}"><i class="fas fa-eye"></i></a>  
                    <a class="btn btn-warning btn-sm" href="{{ route('service.edit',$service->id) }}"><i class="fas fa-edit"></i></a>
                    <a class="btn btn-danger btn-sm" href="{{ route('service.destroy',$service->id) }}"><i class="fas fa-trash"></i></a>
                  </td>  
                </tr> 
        @endforeach
      </tbody>
